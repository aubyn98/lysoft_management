<template>
  <div class="page">
    ...
    <content-table :columns.sync="contentColumn" name="MaterielSalesReturnContentTable">
      <template #a>
        <edit-table
          ref="editTable"
          name="MaterielSalesReturnLeft"
