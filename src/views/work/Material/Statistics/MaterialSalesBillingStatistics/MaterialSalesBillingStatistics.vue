    ...
    <div class="page-RowContent">
      <div class="page-RowContent-item" data-left>
        <search-table
          ...
          span-method
          ref="searchTable"
          name="MaterialSalesBillingStatisticsTable"
...
export default {
  ...
  data () {
    return {
      columnsXx,
      formItems,
      api: 'getMaterialSalesBillingStatistics',
      attach: {},
      groupKey: ['dh', 'khmc', 'rq', 'ckmc'],
      mergeColumns: ['khmc', 'khlx', 'rq', 'dh', 'lsdh', 'wlbh', 'wlmc', 'lx', 'dw', 'ckmc']
    }
  },
  methods: {
    rowDblclick () {}
