    ...
    <div class="page-RowContent">
      ...
      >
        <auto-form
          ...
          label-position="top"
        />
        <el-checkbox v-model="attach.ycwsh">隐藏未审核记录</el-checkbox>
        <el-button
          type="primary"
          size="mini"
...
export default {
  ...
  data () {
    return {
      columnsXx,
      api: 'getMaterialActivityTable',
      attach: {
        ycwsh: false
      },
      groupKey: ['dh', 'wlmc', 'wllx', 'rq1', 'lb'],
      mergeColumns: ['rq1', 'wllx', 'dh', 'wlbh', 'wlmc', 'lb'],
      tableData: [],
      formItems
    }
  },
